function FC_Process_filt_Avi(subject,BOLDlist,FDthresh,TR,outfolder,outprefix)
...
all_regressors = [motion_regressors ; physio_regressors_plusdeltas; runregressors ; sessregressors]';
