...
choose_T1 = false;
copy_rawBOLDdata = false;
T1_preprocess = false;
T1_segment = false;
T2_preprocess = false;
surface_registration = false;
DTI_preprocess = false;
...
sliceorderfile = '/home/data/scripts/Resources/sliceorder_interleavedPhillips_bak_rev.txt';
...
for subnum = 1:subcount
    ...
    try
        ...
        rawfolder = ['/home/data/subjects/' subject '/raw/'];
        DTIfolder = ['/home/data/subjects/' subject '/DTI/']; mkdir(DTIfolder)
        preprocfolder = ['/home/data/subjects/' subject '/preprocessed/']; mkdir(preprocfolder)
