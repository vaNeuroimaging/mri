                ...
                for runnum = 1:length(BOLDrunnames)
                    ...
                    if (length(BOLDfilename) >= length(functional_sequences{seq})) && strcmp(BOLDfilename(1:length(functional_sequences{seq})),functional_sequences{seq});
                        ...
                        if apply_fieldmap
                            ...
                            [systemresult{end+1,1},systemresult{end+1,2}] = system(['flirt -in ' BOLDfile '_st_mcf_avg_bet_uwrp -ref '  firstrun_name{seq} '_st_mcf_avg_bet_uwrp -cost normcorr -dof 12 -omat ' BOLDfile '_avg_2' firstrun_name{seq} '_avg.mat']);
                            ...
                            [systemresult{end+1,1},systemresult{end+1,2}] = system(['flirt -in ' BOLDfile '_st_mcf_avg_bet -ref '  firstrun_name{seq} '_st_mcf_avg_bet -cost normcorr -dof 12 -omat ' BOLDfile '_avg_2' firstrun_name{seq} '_avg.mat']);
