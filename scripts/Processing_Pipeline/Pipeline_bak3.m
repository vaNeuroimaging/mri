    ...
    try
        ...
        if infomap
            ...
            for seq = 1:length(functional_sequences)
                ...
                outcifti = ft_read_cifti_mod([ciftifolder '/cifti_timeseries_normalwall/' functional_sequences{seq} '_LR_surf_subcort_333_32k_fsLR_smooth2.55.dtseries.nii']);
