...
%subjects = '/home/data/subjects/processing_list_101116.txt';
...
infomapthresholds = [[.002 : .001 : .004] [.005 : .005 : .05]];% [.06 : .01 : .1] [.125 :.025 .2]];
infomap_minsize = 400;
infomapreps = 30;
    ...
    %try
        ...
        if infomap
            ...
            for seq = 1:length(functional_sequences)
                ...
                consensus_maker_knowncolors_alt_plusstripes([outfolder '/rawassn_minsize' num2str(infomap_minsize) '_regularized.dscalar.nii'])
                
                cifti_to_border_v2(['rawassn_minsize' num2str(infomap_minsize) '_regularized_recoloredv4.dscalar.nii'],1,1,'default')
...
%                 
                 ...
                 consensus_maker_knowncolors_alt([parcel_infomapfolder '/rawassn_minsize' num2str(parcel_infomap_minsize) '_regularized.dscalar.nii'],[],[],[],[],parcelfile)
