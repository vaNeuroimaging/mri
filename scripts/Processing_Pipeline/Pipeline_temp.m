...
for subnum = 1:subcount
    ...
    try
        ...
        preprocfolder = ['/home/data/subjects/' subject '/preprocessed_2/']; mkdir(preprocfolder)
...
for subnum = 1:subcount
    ...
    try
        ...
        if T1_hippocampal_subfields
            ...
            [systemresult{end+1,1},systemresult{end+1,2}] = system(['mv ' freesurfer6folder '/* ' freesurfer6folder '/' subject '/']);
