function [g1g2_diff_mat group1_gstar group2_gstar pvalue] = OODA_weighted_pairedPvalue(graphs,groups,numperms,stemname)
%
% Name:OODA_weighted_pairedPvalue.m
% $Revision: 1.1 $
% $Date: 2015/08/05 14:57:46 $
...
fprintf(fid,'source("%s/OODA_weighted_paired_permutation.R")\n',homedir);
