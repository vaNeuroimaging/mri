function parcel_correlmat_figmaker_alt(corrmat,assignmentsfile,limits,titlename)
...
colors = [.5 .5 .5;1 0 0;0 0 .6;.9 .9 0;1 .7 .4;0 .8 0;1 .6 1;0 .6 .6;0 0 0;.3 0 .6;.2 1 1;1 .5 0;.6 .2 1;0 .2 .4;.2 1 .2;0 0 1;.85 .85 .85;.0 .4 0;.8 .35 .5;.5 .75 .2];

nodes = size(corrmat,1);

yaxis_label_position_params = [1.4 (nodes/100) * -2]; %horiz vert
...
assignments(assignments==4) = 1.5;
assignments(assignments==6) = 9.5;
assignments(assignments==17) = 11.5;
...
[~,IDsort] = sort(IDs);
networklabels = networklabels(IDsort);
colors = colors(IDsort,:);
