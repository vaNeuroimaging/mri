...
for i = 1:length(cifti_parcellations_totest)
    ...
    generate_rotated_parcellation_andPCA_nobaddata_generic([L_name '.func.gii'],iterations,cov_corr_L,rotations,L_datainds,'L',L_name,L_baddata);
    ...
    %Run the homogeneity testing
    generate_rotated_parcellation_andPCA_nobaddata_generic([R_name '.func.gii'],iterations,cov_corr_R,rotations,R_datainds,'R',R_name,R_baddata);
