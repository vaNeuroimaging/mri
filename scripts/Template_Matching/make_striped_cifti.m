...
spherical_surfaces_32k = {'/home/data/scripts/Resources/Conte69_atlas-v2.LR.32k_fs_LR.wb/Conte69.L.sphere.32k_fs_LR.surf.gii','/home/data/scripts/Resources/Conte69_atlas-v2.LR.32k_fs_LR.wb/Conte69.R.sphere.32k_fs_LR.surf.gii'};
spherical_surfaces_164k = {'/home/data/subjects/MAV006/fs_LR/MNI/MAV006.L.sphere.164k_fs_LR.surf.gii','/home/data/subjects/MAV006/fs_LR/MNI/MAV006.R.sphere.164k_fs_LR.surf.gii'};

wbdir = '/usr/local/workbench/bin_rh_linux64/';

surfaceareas = ft_read_cifti_mod('/home/data/scripts/Resources/Conte69_atlas-v2.LR.32k_fs_LR.wb/Conte69.LR.midthickness.32k_fs_LR_surfaceareas_cortexonly.dtseries.nii');
...
mask_32k{1} = gifti(['/home/data/scripts/Resources/Conte69_atlas-v2.LR.32k_fs_LR.wb/parcellations_VGD11b.L.32k_fs_LR.label.gii']); mask_32k{1} = ~mask_32k{1}.cdata(:,3);
mask_32k{2} = gifti(['/home/data/scripts/Resources/Conte69_atlas-v2.LR.32k_fs_LR.wb/parcellations_VGD11b.R.32k_fs_LR.label.gii']); mask_32k{2} = ~mask_32k{2}.cdata(:,3);

mask_164k{1} = gifti(['/home/data/scripts/Resources/Conte69_atlas.LR.164k_fs_LR/parcellations_VGD11b.L.164k_fs_LR.label.gii']); mask_164k{1} = ~mask_164k{1}.cdata(:,3);
mask_164k{2} = gifti(['/home/data/scripts/Resources/Conte69_atlas.LR.164k_fs_LR/parcellations_VGD11b.R.164k_fs_LR.label.gii']); mask_164k{2} = ~mask_164k{2}.cdata(:,3);

cifti_out_templatefile = '/home/data/scripts/Resources/Conte69_atlas.LR.164k_fs_LR/Conte69.LR.164k_fs_LR.normalwall_surfaceonly_template.dtseries.nii';
...
system([wbdir 'wb_command -cifti-resample Temp.dtseries.nii COLUMN ' cifti_out_templatefile ' COLUMN BARYCENTRIC ENCLOSING_VOXEL Temp_164.dtseries.nii -surface-largest -left-spheres ' spherical_surfaces_32k{1} ' ' spherical_surfaces_164k{1} ' -right-spheres ' spherical_surfaces_32k{2} ' ' spherical_surfaces_164k{2}]);
...
for hemnum = 1:length(hems)
    hem = hems{hemnum};
    sphere = gifti(['/home/data/subjects/MAV006/fs_LR/MNI/MAV006.' hem '.sphere.164k_fs_LR.surf.gii']);
