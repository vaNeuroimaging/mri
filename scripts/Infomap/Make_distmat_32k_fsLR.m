...
surfcoordsL = gifti('/data/cn/data1/scripts/CIFTI_RELATED/Resources/Conte69_atlas-v2.LR.32k_fs_LR.wb/Conte69.L.midthickness.32k_fs_LR.surf.gii'); 
surfcoordsR = gifti('/data/cn/data1/scripts/CIFTI_RELATED/Resources/Conte69_atlas-v2.LR.32k_fs_LR.wb/Conte69.R.midthickness.32k_fs_LR.surf.gii'); 
...
surfcoordsL = surfcoordsL.vertices(logical(maskL),:);
surfcoordsR = surfcoordsR.vertices(logical(maskR),:);

subcort_coords = cifti.pos((nnz(maskL)+nnz(maskR))+1:end,:);
