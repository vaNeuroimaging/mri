function make_hierarchical_dendrogramv2(recolored_networks_bythresh_file,thresholds)
...
for col = 2:size(data,2)
    ...
    for lostcolor = colorslost(:)'
        if nnz(data(:,col+1:end)==lostcolor)==0
            ...
            lostcolorinds = any(data(:,1:(col-1))==lostcolor,2);
            
            allvalues_inlostcolorinds = data(lostcolorinds,col);
