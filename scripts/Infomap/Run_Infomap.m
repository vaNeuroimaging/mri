function Run_Infomap(rmat, dmatname, xdistance, thresholdarray, makebinary, outdir, numreps, numpools,structure_indices)
%Run_Infomap(rmat, dmatname, xdistance, thresholdarray, makebinary, outdir, [numreps], [numpools],[structure_indices])
%
