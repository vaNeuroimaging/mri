function parcel_creator_basic(edgemetricname,outputdir,filestem,hem,mergethresh)
...
save(gifti(label),[outputdir '/' filestem 'watershedmerge_' num2str(mergethresh) '.func.gii']);
