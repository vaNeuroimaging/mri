...
ribbonname = [surfdir '/MNI/Ribbon/ribbon_333.nii.gz'];
if ~exist(ribbonname)
    evalc(['!csh /data/scripts/Cifti_creation/create_ribbon_singlesub.csh ' subject ' ' surfdir ' T1_avg_biascorr_MNI.nii.gz 3'])
end
