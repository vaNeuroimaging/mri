function  surface_parcellation_subsurf_nosmooth_allgrad_upsamplevol(tmasklist,targetres)
...
corrtemplatefile = ['Template_' targetres '_corr.func.gii'];

template_file = ['Template_' targetres '.dtseries.nii'];
...
%             output(59412+1:end) = labels_avg;
            ...
            cifti_write_wHDR(labels_avg,template_file,[outputdir '/' gradsname '_smooth' num2str(smooth) '_wateredge_avg_' targetres])
