function  surface_parcellation_concat_cifti_wateredge_nocrap(cohortfile,outputdir,tmasktype,hems,edges)
...
roidir = '/data/cn4/evan/RestingState/FC_Mapping_120_nocrap/';
HEMS = {'L';'R'};
hemname = {'LEFT';'RIGHT'};
...
cifti_files{s,1} = ['/data/cn4/evan/RestingState/FC_Mapping_120_nocrap/cifti_timeseries_goodvoxels/' subjects{s} '_BOLD_LR_surf_subcort_32k_fsLR_smooth2.55.dtseries.nii'];
...
for hem = h   
    ...
    switch tmasktype
        case 'none'
            system([workbenchdir '/wb_command -cifti-correlation ' outputdir '/' time_concat ' ' outputdir '/' concat_corr ' -roi-override -' hemname_low{hem} '-roi ' roidir '/' HEMS{hem} '.atlasroi_erode3_nocrap.32k_fs_LR.shape.gii -fisher-z'])
 
        otherwise
            system([workbenchdir '/wb_command -cifti-correlation ' outputdir '/' time_concat ' ' outputdir '/' concat_corr ' -roi-override -' hemname_low{hem} '-roi ' roidir '/' HEMS{hem} '.atlasroi_erode3_nocrap.32k_fs_LR.shape.gii -weights ' outputdir '/allsubs_total_tmask.txt -fisher-z'])
    ...
    medial_wall = gifti([roidir '/' HEMS{hem} '.atlasroi_erode3_nocrap.32k_fs_LR.shape.gii']);   
