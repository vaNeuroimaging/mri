function wta_grp_cifti_distanceexclude(ciftilist,tmasklist,cortical_map,subcort_map,regionname,corr_type,sign,xdistance)
...
fprintf(log,'wta_grp.m log\n corrfile = %s\n cortical map = %s\n subcortical map = %s\n region = %s\n correlation type = %s\n sign = %s\n distance exclusion = %s\n', ...
    ciftilist,cortical_map,subcort_map,regionname,corr_type,sign,num2str(xdistance));
fclose(log);
...
for i = 1:numel(subjectlist)
    ...
    L_surf_coordfile = ['/data/cn4/segmentation/freesurfer5_supercomputer/FREESURFER_fs_LR/' subject '/7112b_fs_LR/fsaverage_LR32k/' subject '.L.midthickness.32k_fs_LR.coord.gii'];
    L_surf_coords = gifti(L_surf_coordfile); L_surf_coords = L_surf_coords.vertices;
    R_surf_coordfile = ['/data/cn4/segmentation/freesurfer5_supercomputer/FREESURFER_fs_LR/' subject '/7112b_fs_LR/fsaverage_LR32k/' subject '.R.midthickness.32k_fs_LR.coord.gii'];
