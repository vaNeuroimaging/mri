...
[datalist,tmasklist,fcprocessed_funcdata_dir,fcprocessed_funcdata_dir_suffix,outfolder,subcort_mask,fs_LR_surfdir,medial_mask_L,medial_mask_R,smoothnum] = feval(paramsname);
