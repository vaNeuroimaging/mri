...
save(gifti(single(groupassignoutput)),[outputfolder 'Group_parcels_matchtosubs3_' hem '.func.gii'])

save(gifti(single(groupsimilarityoutput)),[outputfolder 'Group_parcels_matchtosubs3_similarity_' hem '.func.gii'])

%save(gifti(single(groupdistanceoutput)),[outputfolder 'Group_parcels_assignedtosubs_distance_' hem '.func.gii'])

save(gifti(single(subassignoutput)),[outputfolder 'Subject_parcels_matchtogroup3_' hem '.func.gii'])

save(gifti(single(subsimilarityoutput)),[outputfolder 'Subject_parcels_matchtogroup3_similarity_' hem '.func.gii'])
...
save(gifti(single(parcelexistancemap)),[outputfolder 'Group_parcels_matchnumber3_' hem '.func.gii']);
save(gifti(single(parceloverlapmap)),[outputfolder 'Sub_parcels_overlap3_' hem '.func.gii']);
