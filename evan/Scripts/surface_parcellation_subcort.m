function  surface_parcellation_subcort(cohortfile,tmasklist,outputdir)
...
for s = 1:length(subjects)
    ...
    if s==1
        ...
        fullgrads = zeros(nsubcortverts,size(cifti_timecourse,1),'single');
    ...
    corrofcorr =paircorr_mod(cifti_corrmap(:,ncortverts+1:end),cifti_corrmap);
    clear cifti_corrmap
