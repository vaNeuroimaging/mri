...
[funcdata tmaskfiles surfdirs subjects] = textread(cohortfile,'%s %s %s %s');
...
for s=1:subnum
    ...
    funcvols{s,1} = funcdata{s}(slashloc(end)+1:extensionloc-1);
end
...
%         
    ...
    %save(['avgcrosscorr' HEMS{hem} '.mat'],'avgcrosscorr','-v7.3')
