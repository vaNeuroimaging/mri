...
outputstatsfile = [outputfolder '/WatershedAssignments_minimadist5_manyoverlapthresh_comparegroupparcel.txt'];
...
for s = 1:subnum
    ...
    for parcelnum = 1:size(groupwatershed,2)
            ...
            groupwatershedmapnomed = avgcorrelmat(parcelnum,:); groupwatershedmapnomed(medialmaskind) = 0;
