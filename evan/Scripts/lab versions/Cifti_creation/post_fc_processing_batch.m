...
% Load parameters
if strcmp(post_fc_processing_batch_params_file(end-1:end),'.m')
    post_fc_processing_batch_params_file = post_fc_processing_batch_params_file(1:end-2);
end
feval(post_fc_processing_batch_params_file);
...
for s  = 1:length(subjects)
    ...
    subfunc = [fcprocessed_funcdata_dir '/' subject '/' subject '_333_zmdt_resid_bpss_zmdt_g7'];
