...
allparcelfilenames = {'/data/cn4/evan/RestingState/BabySibs/C1/C1_Baby_28sub_nosmooth_L_threshperc0.45_minparcel20watershedmerge_0.45.func.gii','/data/cn4/evan/RestingState/BabySibs/C1/C1_Baby_28sub_nosmooth_R_threshperc0.45_minparcel20watershedmerge_0.45.func.gii';...
    '/data/cn4/evan/RestingState/BabySibs/C2/C2_Baby_28sub_nosmooth_L_threshperc0.45_minparcel20watershedmerge_0.45.func.gii','/data/cn4/evan/RestingState/BabySibs/C2/C2_Baby_28sub_nosmooth_R_threshperc0.45_minparcel20watershedmerge_0.45.func.gii';...
    '/data/cn4/evan/RestingState/BabySibs/Homogeneity_testing_in_adult_C1/C1_adult_parcels_L.func.gii','/data/cn4/evan/RestingState/BabySibs/Homogeneity_testing_in_adult_C1/C1_adult_parcels_R.func.gii';...
    '/data/cn4/evan/RestingState/BabySibs/Homogeneity_testing_in_adult_C2/C2_adult_parcels_L.func.gii','/data/cn4/evan/RestingState/BabySibs/Homogeneity_testing_in_adult_C2/C2_adult_parcels_R.func.gii'};

directories = {'/data/cn4/evan/RestingState/BabySibs/C1/','/data/cn4/evan/RestingState/BabySibs/C2/','/data/cn4/evan/RestingState/BabySibs/Homogeneity_testing_in_adult_C1/','/data/cn4/evan/RestingState/BabySibs/Homogeneity_testing_in_adult_C2/'};


for c=3:length(directories)
    cd(directories{c})
    ...
    if makenewrotations
        ...
        save('/data/cn4/evan/RestingState/BabySibs/C1/rotations.mat','rotations')
        
    else
        
        %load('rotations_all.mat')
        load('/data/cn4/evan/RestingState/BabySibs/C1/rotations.mat')
