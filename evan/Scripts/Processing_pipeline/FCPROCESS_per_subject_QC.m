function [allends switches] = FCPROCESS_per_subject_QC(datalist, tdir, tmasktype, cleanup, roilist, freesurfer_datapath_file, varargin)
%[allends switches] = FCPROCESS_per_subject_QC(datalist, tdir, tmasktype, cleanup, roilist, freesurfer_datapath_file, varargin)
% jdp 2/22/2012
%
