surfoutputdir = '/data/cn4/evan/Nelson/surf_timecourses/';
fcdatadir = '/data/cn4/evan/Nelson/FCPROCESS_nosmooth/';
surfdir = '/data/cn4/evan/Nelson/FREESURFER/FREESURFER_fs_LR/';
...
datapaths = {'/data/cn4/evan/Nelson'};
subjects = {'VISN17'};
...
%ciftioutputdir2 = '/data/cn5/selfRegulation/V4Process_nosmooth/cifti_smallwall_timeseries/';
ciftioutputdir2 = '/data/cn4/evan/Nelson/cifti_normalwall_timeseries/';
...
for s = 1:length(subjects)
    ...
    gunzip([subfunc '.nii.gz'])
    disp(['Creating cifti for subject ' num2str(s)])
    system(['wb_command -cifti-create-dense-timeseries ' ciftioutputdir2 subjects{s} '_BOLD_LR_surf_subcort_32k_fsLR_smooth2.55.dtseries.nii -volume ' subfunc '.nii /data/cn4/laumannt/subcortical_mask/mode_subcortical_label_LR_333.nii -left-metric ' surfoutputdir '/' subjects{s} '_L_time_333_dil10_32k_fsLR_smooth' smooth '.func.gii -roi-left /data/cn4/laumannt/subcortical_mask/L.atlasroi.32k_fs_LR.shape.gii -right-metric ' surfoutputdir '/' subjects{s} '_R_time_333_dil10_32k_fsLR_smooth' smooth '.func.gii -roi-right /data/cn4/laumannt/subcortical_mask/R.atlasroi.32k_fs_LR.shape.gii'])
