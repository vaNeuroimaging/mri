...
outputfolder = '/data/cn4/evan/RestingState/FC_Mapping_120/120_wateredge_crossthresh/';
...
outputstem = '120_wateredge_crossthresh';
...
surftimedir = '/data/cn4/laumannt/fcMapping_redux/FCPROCESS_NEW_042213/cifti_timeseries_goodvoxels/';
%surftimedir = '/data/cn4/evan/RestingState/FC_Mapping_120/nosmooth/';
...
[funcdata tmasks surfdirs subjects] = textread(cohortfile,'%s %s %s %s');
