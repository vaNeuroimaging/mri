...
allparcelfilenames = {'/data/cn4/evan/RestingState/FC_Mapping_120/120_L_wateredgethresh_watershedmerge_0.45.func.gii','/data/cn4/evan/RestingState/FC_Mapping_120/120_R_wateredgethresh2_watershedmerge_0.45.func.gii'};
for i = 4:42
    allparcelfilenames(i-2,1:2) = {['/data/cn4/evan/ROIs/Craddock/Craddock' sprintf('%04i',i) '_L.func.gii'],['/data/cn4/evan/ROIs/Craddock/Craddock' sprintf('%04i',i) '_R.func.gii']};
end
...
resultsfolder = '/data/cn4/evan/RestingState/FC_Mapping_120/';
...
try
    thishem = load([parcelfilenames{hemnum}(1:end-9) '.mat']);
catch
    thishem = load([parcelfilenames{hemnum}(1:end-9) '_.mat']);
end
...
plot(realsizes,median(rotated_eigvals,2)','.','MarkerSize',20,'Color',[0 0 1])
...
for craddockparcelset = 2:size(allparcelfilenames,1)
    craddockmeans(craddockparcelset-1) = mean(allranks{craddockparcelset});
end
plot([4:42],craddockmeans,'r-')
