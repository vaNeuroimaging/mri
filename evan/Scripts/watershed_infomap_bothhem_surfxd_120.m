...
watershednames = {'120_R_wateredgethresh_watershedmerge_0.45_gooddata.func.gii'};%,'120_R_wateredgethresh_watershedmerge_0.45.func.gii'};%,'Poldrome_R_crossthresh_watershedmerge.func.gii'};
%corrmatname = 'corrmat.mat';
corrmatname = 'Merged_tomatch_gooddata_R_corrmat.mat';
roifilename = 'parcel_center.roi';
%outputfolder = [waterdir '/120_R_infomap_gooddata/'];
...
%     xdistancemat(heminds,otherheminds) = hemxdistancemat;
    ...
    xdistancemat = surf_distances{hem}(parcelcenterinds{hem},parcelcenterinds{hem});
    xdistancemat = xdistancemat > distanceexclusion;
end
