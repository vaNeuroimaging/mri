...
% 
seeds = {'Task50peak_raIns','Task50peak_rdlPFC'};
%{'DC','dACC','PCC','vmPFC','rdlPFC'};
%,'Vis'

seednames = {'/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ROI_analysis/Task50peak_raIns_roi.mat','/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ROI_analysis/Task50peak_rdlPFC_roi.mat'};
%{'/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ROI_analysis/PCC_CandG_roi.mat'};
%{'/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ICA/ICA_79.gica/ROIs/6mm/TPN-lFPC-dlPFC_roi.mat'};
%{'/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ROI_analysis/diMartino/DC_bilat_roi.mat','/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ICA/ICA_79.gica/ROIs/6mm/TPN-Sal-dACC_roi.mat','/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ICA/ICA_79.gica/ROIs/6mm/TNN-aDMN-PCC_roi.mat','/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ICA/ICA_79.gica/ROIs/6mm/TNN-aDMN-vmPFC_roi.mat','/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ICA/ICA_79.gica/ROIs/6mm/TPN-rFPC-dlPFC_roi.mat'};
%,'/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ICA/ICA_79.gica/ROIs/6mm/TNeut-Vis-med_roi.mat'
...
for seednum = 1:length(seeds)
    ...
    for subject = 1:length(subjects)
        ...
        for run = 1:length(runs)
            ...
            outputfile = ['/fmri/data3/Evan/Gene-Rest-Nback/Analysis/' subjid '/Nonstationarity/'];
            ...
            if isempty(dir(datafiles3D))
                datafiles3D = [data_location 'sw*.nii'];
            end
