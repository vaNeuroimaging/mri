...
roi_names = {'rFPC-rdlPFC'    'rFPC-rvlPFC' 'rFPC-rPar' 'lFPC-ldlPFC'   'DA-rPar' 'DA-lPar' 'Sal-raIns' 'Sal-laIns'  'Sal-ramfg'  'Sal-lamfg'  'Striatum-r' 'Striatum-l'  'aDMN-vmPFC' 'aDMN-PCC' 'pDMN-rAG' 'pDMN-lAG'};
    %'rFPC-rdlPFC' 'rFPC-rvlPFC' 'rFPC-rPar' 'sal-SMA' 'sal-laIns' 'sal-raIns' 'sal-lmfg' 'sal-rmfg' 'str-l' 'str-r' 'DMN-vmPFC' 'DMN-Prec' 'DMN-lAG'};
...
if behaviorcorrel ==1
    ...
    for behavnum = 8:length(behavior)
        for run=1:length(runs)
