...
outputfilename = 'ConnectivityOutput_filt_interleave.txt';
%'ConnectivityOutput_spm8.txt';

Datasavename = 'PairwiseData_filt_interleave';
...
roi_names = {'rFPC-rdlPFC' 'rFPC-rvlPFC' 'rFPC-rPar' 'sal-SMA' 'sal-laIns' 'sal-raIns' 'sal-lmfg' 'sal-rmfg' 'str-l' 'str-r' 'zDMN-vmPFC' 'zDMN-Prec' 'zDMN-lAG'};
    ...
    for run = 1:length(runs)
        ...
        for subject = 1:length(subjects)
            ...
            if strcmp(runs{run},'Nback')
                ...
                neworder = randperm(m);
                P = P(neworder,:);
                motionparams = motionparams(neworder,:);
            end
