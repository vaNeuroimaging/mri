...
analysis_dir = '/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ICA/ICA_79.gica/ROIs/Cluster/';
%'/fmri/data3/Evan/Gene-Rest-Nback/Analysis/ICA/ICA_79.gica/ROIs/Network/TPN-TNN/';
...
%,'vmPFC activation','Prec Activation','dACC activation','lIPL
%activation','ldlPFC activation','rIPL activation','rdlPFC activation'
...
if makenew ==1
    save([analysis_dir Datasavename],'Stdwindowcorrelvectors','RunTtestTVal','RunTtestPVal','FDRpvector','Fisherwindowcorrelvectors')
end
