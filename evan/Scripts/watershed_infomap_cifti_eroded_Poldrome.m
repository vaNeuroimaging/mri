...
watershednames = {'Poldrome_R_crossthresh_watershedmerge.func.gii'};%,'Poldrome_R_crossthresh_watershedmerge.func.gii'};
corrmatname = 'corrmat.mat';
roifilename = 'parcel_center.roi';
outputfolder = '/data/cn4/evan/RestingState/Ind_variability/Poldrome/Poldrome_R_crossthresh_infomap/';
...
outputstem = 'Poldrome_R_crossthresh';
...
timeseriesdataname = '/data/cn4/evan/RestingState/Ind_variability/Poldrome/allsubs_LR_timeseries.func.gii';
allsubstmask = '/data/cn4/evan/RestingState/Ind_variability/Poldrome/allsubs_total_tmask.txt';
