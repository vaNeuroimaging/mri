function this = gifti_evan(varargin)
        ...
        elseif ischar(varargin{1})
            ...
            if strcmpi(e,'.mat')
                ...
                if strcmp(varargin{1}(1),'/')
                    ...
                    filename = [pwd '/' varargin{1}];
                end
                cd /data/cn4/laumannt/surface_parcellation_code/@gifti/private/
                this = read_gifti_file_standalone(filename,giftistruct);
                cd(thisdir)
%                this = class(this,'gifti');
            end
