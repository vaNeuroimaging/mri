function [submatches,groupmatches] = networkClusters_match_preclustered_withvol(subclustermap,subclusternetworkIDs,distances,groupclustermap,groupclusternetworkIDs,distthresh)
...
npoints = size(groupclustermap,1);
...
groupmatches = zeros(npoints,0);
submatches = zeros(npoints,0);
