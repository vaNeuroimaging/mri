function watershed_algorithm_submatchtogroup_merge3(edgemetricname,outputdir,hem,subname)
...
save(gifti(edgethresh_subassignmap),[outputdir '/' filestem '_' hem '_watershedmatchtogroup.func.gii']);
