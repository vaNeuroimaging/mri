...
%     end
    ...
    for parcelnum = 1:length(parcelIDs)
        ...
        if maxQval(parcelnum) >= Qvalcutoff
...
%             end
        ...
        %Q_output(parcels_upsampled==parcelIDs(parcelnum)) = maxQval;
        end
    
     save(gifti(single(finaloutput)),['Parcel_networkIDs_subjectvariability_UPGMA_maxQ_minsize_' num2str(networksizeminimum) '_' hem '_164_alt2.func.gii']);
     save(['Parcel_networkIDs_subjectvariability_UPGMA_maxQ_minsize_' num2str(networksizeminimum) '_' hem '_164_alt2.mat'],'parcelIDs','clusterconnections','clustersizes','maxQval')
