function  surface_parcellation_cifti_smallwall_wateredge_remover_evan(tmasklist,outputdir,hems,edges,subindex)
...
tmaskfiles = tmaskfiles(subindex);
...
%         
%         funcpath = '/data/cn4/laumannt/fcMapping_redux/FCPROCESS_NEW_042213/cifti_timeseries_goodvoxels/';
%         cifti_file = [subjects{s} '_BOLD_LR_surf_subcort_32k_fsLR_smooth2.55'];
%         
%         % Tmask data
...
%     end
    ...
    avgcorrfilename = [outputdir '/avg_corr_' HEMS{hem} '.dconn.nii'];
