...
%parcel_creator_subcort(edgeciftiname,filestem,threshperc)
...
%Get node neighbors
global neighbors
neighbors = cifti_neighbors(edgeciftiname);%'/data/hcp-zfs/home/laumannt/120_parcellation/cifti_timeseries_normalwall/vc25125_BOLD_LR_surf_subcort_32k_fsLR_smooth2.55.func.gii');
