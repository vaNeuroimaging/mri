function  surface_parcellation_subsurf_nosmooth_allgrad_groupavg
...
cifti_corrmap = cifti_read('/data/hcp-zfs/home/laumannt/120_parcellation/cifti_correlation_normalwall/120_avg_corr_LR.dconn.nii');
...
%        delete('Temp_subdata_corr_nonan.dconn.nii')
        ...
        cifti_write_wHDR(corrofcorr,corrtemplatefile,['Temp_corrofcorr'],'dconn')
        clear corrofcorr
        toc
        % Calculate gradients
        disp('Calculating gradient')
%        gradsname = [];
        evalc(['!' workbenchdir '/wb_command -cifti-gradient Temp_corrofcorr.dconn.nii COLUMN ' gradsname '.dconn.nii -left-surface ' surf_L ' -right-surface ' surf_R])%' -surface-presmooth 2.55']);
