function eta_metric = spatial_eta_metric(metric1,metric2,neighdist,outputdir,outputname)
...
for i = 1:length(metric1)
    ...
    eta_metric(i) = eta_calc_TL_simple(metric1_val,metric2_val);
end

  %save(gifti(single(eta_metric)),[outputdir '/' outputname '.func.gii']);
