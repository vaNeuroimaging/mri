...
bufsize=16384;
surfneighborfile = '/data/cn4/laumannt/standard_mesh_atlases/Conte69_atlas.LR.32k_fs_LR_glasser/fsaverage_LR32k/node_neighbors.txt';
...
if isfield(cifti,'transform')
    ...
    for vox = 1:size(volpos,1)
        ...
        if separate_structures
            thisvox_neighbors(volstructs(thisvox_neighbors)~=volstructs(vox)) = [];
        end
