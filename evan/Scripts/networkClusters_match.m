function [submatches,groupmatches] = networkClusters_match(subnetworksfilename,distances,groupnetworksfile)
...
orig_groupsize = size(groupnetworks,1);
orig_subsize = size(subnetworks,1);
