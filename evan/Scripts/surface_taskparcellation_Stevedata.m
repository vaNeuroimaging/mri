...
voldata = '/data/cn4/evan/Task_parcellation/Manytasks_subregister/Manytasks.4dfp.img';
surfdata = ['/data/cn4/evan/Task_parcellation/Manytasks_subregister/Manytasks_' hem '.func.gii'];
smooth = 'no';
edges = 'yes';
