function  surface_parcellation_allstructures_subsampled_randomdata2(cohortfile,tmasklist,outputdir)
...
for s = 1:length(subjects)
    ...
    cifti_file = ['/data/cn4/evan/Temp/surface_parcellation_randomdata_innative_deformed/cifti_timeseries/' subject '_LR_surf_subcort_333_32k_fsLR_smooth2.55.dtseries.nii'];
