function  surface_parcellation_bothhem(cohortfile,tmasklist,outputdir)
...
for s = 1:length(subjects)
    ...
    if s==1
        ...
        fullgrads = zeros(ncortverts,size(cifti_timecourse,1),'single');
    ...
    clear corrofcorr
    ft_write_cifti_mod([outputdir '/corrofcorr_LR'],ciftistruct_surfonly);
...
ciftistruct_surfonly.data = fullgrads;
clear fullgrads
gradsname = 'avg_corrofcorr_allgrad_LR';
ft_write_cifti_mod(gradsname,ciftistruct_surfonly);
ciftistruct_surfonly.data = [];
...
ft_write_cifti_orig([outputdir '/' gradsname '_smooth' num2str(smooth) 'avg'],ciftistruct_surfonly);
...
ciftistruct_surfonly.data = edge_density;
...
ciftistruct_surfonly.data = edges;
