function [submatches,groupmatches] = networkClusters_match_preclustered_bak(subclustermap,subclusternetworkIDs,distances,groupclustermap,groupclusternetworkIDs,distthresh)
