function [matrix r kden] = matrix_thresholder_onlyrs(matrix,threshold,thresholdtype)
%
...
for i=1:repsneeded
    ...
    numthreshedges=nnz(matrix>=tempthresh); % apply the threshold, create logical array
    kden2=numthreshedges/(numedges); % calculate the edge density
