...
%     end
    ...
    for parcelnum = 1:length(parcelIDs)
        ...
        lines_within_parcel(lines_within_parcel==0)=[];
            ...
            sortedcommunities = communities(sortorder);
            for comnum = 1:length(communities)
     ...
     save(gifti(single(finaloutput)),['Parcel_networkIDs_subjectvariability_UPGMA_maxQ_minsize_' num2str(networksizeminimum) '_' hem '_164.func.gii']);
     save(gifti(single(multiclusteroutput)),['Parcel_networkIDs_subjectvariability_UPGMA_maxQ_orderedclusters_minsize_' num2str(networksizeminimum) '_' hem '_164.func.gii']);
