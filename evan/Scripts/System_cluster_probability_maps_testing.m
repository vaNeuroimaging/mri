...
if new_cluster
    ...
    surfacearea = ft_read_cifti_mod('/data/cn4/evan/fsaverage_LR32k/Conte69.LR.midthickness.32k_fs_LR_surfaceareas.dtseries.nii');
...
for distthresh = distthreshes
    distances = smartload('/data/cn4/evan/fsaverage_LR32k/Cifti_geo_distances_uint8.mat');
    
    outdir = ['/data/cn4/evan/RestingState/Ind_variability/120_allsys_clean30mm_clusteringbyotherdistances/' num2str(distthresh) 'mm/'];
    mkdir(outdir)
    cd(outdir)
...
surfacearea = ft_read_cifti_mod('/data/cn4/evan/fsaverage_LR32k/Conte69.LR.midthickness.32k_fs_LR_surfaceareas.dtseries.nii');
surfacearea = surfacearea.data;
neighbors = cifti_neighbors('/data/cn4/evan/fsaverage_LR32k/Conte69.LR.midthickness.32k_fs_LR_surfaceareas.dtseries.nii');
