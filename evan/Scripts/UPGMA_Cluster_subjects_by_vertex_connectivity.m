...
for hemnum = 1:length(hems)
    ...
    outputfolder = ['/data/cn4/evan/RestingState/FC_Mapping_120/Subject_clustering_vertexwise/'];
...
%             end
            subtimecourse = gifti(['Subject' num2str(subnum) '.func.gii']); subtimecourse = subtimecourse.cdata;
