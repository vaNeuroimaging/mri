function parcel_creator(edgemetricname,outputdir,filestem,hem,threshperc)
...
save(gifti(label),[outputdir '/' filestem '_' num2str(round(threshperc*100)/100) '.func.gii']);
