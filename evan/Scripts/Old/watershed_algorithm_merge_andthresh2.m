function watershed_algorithm_merge_andthresh2(edgemetricname,outputdir,filestem,hem,thresh)
%watershed_algorithm_merge_andthresh2(edgemetricname,outputdir,filestem,hem,thresh)
...
disp('Eliminating high edge value vertices')
