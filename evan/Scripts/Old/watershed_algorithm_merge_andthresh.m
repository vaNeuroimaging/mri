function watershed_algorithm_merge_andthresh(edgemetricname,outputdir,filestem,hem,thresh)
%watershed_algorithm_merge_andthresh(edgemetricname,outputdir,filestem,hem,thresh)
