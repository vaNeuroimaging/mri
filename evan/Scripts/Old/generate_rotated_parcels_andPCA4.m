function generate_rotated_parcels_andPCA4(watershedname,iterations,avgcrosscorr,iscifti,hem,geo_distances,outfileprefix)
...
for parcelnum = 1:numparcels
    ...
    %find parcel center
        ...
        valid_targets = find(~(any((geo_distances_frombad<=maxdist),1)));
