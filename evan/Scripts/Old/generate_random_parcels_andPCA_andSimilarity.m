function generate_random_parcels_andPCA_andSimilarity(watershedname,iterations,avgcrosscorrname,iscifti,hem,outfileprefix)
...
%     end
   ...
   Simvals = parcel_similarity(label,avgcrosscorr,iscifti,'/data/cn4/evan/Temp/Temp.func.gii','L');
   ...
   for watershednum = 1:length(watersheds)
       ...
       randomsimilarities(watershednum,iter) = mean(Simvals(templabel==watershednum));
   end
...
Simvals = parcel_similarity(realwatershed,avgcrosscorr,iscifti,'/data/cn4/evan/Temp/Temp.func.gii','L');
