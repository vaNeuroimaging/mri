function generate_random_parcels_andPCA_andSimilarity_par(watershedname,iterations,avgcrosscorrname,iscifti,hem,outfileprefix)
...
for iter = 1:iterations
    ...
    fprintf('%12s',['Iteration ' num2str(iter)])
...
tic
Simvals = parcel_similarity_multiple(multilabel,avgcrosscorr,iscifti,'L');
toc
