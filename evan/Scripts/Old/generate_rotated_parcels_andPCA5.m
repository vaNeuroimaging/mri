function generate_rotated_parcels_andPCA5(watershedname,iterations,avgcrosscorr,iscifti,hem,geo_distances,outfileprefix)
...
for parcelnum = 1:numparcels
    ...
    for iternum = 1:iterations
        ...
        watercorr = avgcrosscorr(truerotparcelindices(logical(truerotparcelindices)),:);
