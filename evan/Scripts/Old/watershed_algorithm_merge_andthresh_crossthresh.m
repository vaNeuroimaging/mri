function watershed_algorithm_merge_andthresh_crossthresh(edgemetricname,outputdir,filestem,hem,threshs)
%watershed_algorithm_merge_andthresh_crossthresh(edgemetricname,outputdir,filestem,hem,threshs)
