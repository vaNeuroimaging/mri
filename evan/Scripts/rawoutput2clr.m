function [clrs] =  rawoutput2clr(clrs,varargin)

% jdp 10/10/10
% 
% This script takes a matrix (typically of clustering assignments) and
% organizes it into something that makes sense. The output is returned as a
% variable, and can be written to a file as well if a second argument is
% passed in.
% 
% USAGE: [newclrs] = rawoutput2clr(clrfile,*outputfile*)
% USAGE: [newclrs] = rawoutput2clr(clrmatrix)
