parcelfile = '/data/cn4/evan/Temp/bothhem_parcellation_test/avg_corrmat/Parcels_avg_corrmat_edgethresh_0.35.dtseries.nii';

corrmatname = 'corrmat.mat';
roifilename = 'parcel_center.roi';
outputfolder = ['/data/cn4/evan/Temp/bothhem_parcellation_test/avg_corrmat/infomap_in_120_108/'];
...
distancesfile = '/data/cn4/evan/fsaverage_LR32k/Cifti_geo_distances.mat';
...
if calc_corrmat
    ...
    all_parcel_corrmat = mean(parcel_corrmat,3);
...
%else
%    load([outputfolder '/parcel_distances.mat'])
end
