...
distancesfile = '/data/hcp-zfs/home/laumannt/Poldrome/shared_for_washu/normalwall_distmat_333/distmat_surf_geodesic_vol_euc.mat';
...
load(distancesfile)
distmat_use = distmat_use(1:ncortverts,1:ncortverts);

threshdistance = distmat_use > xdistance;
