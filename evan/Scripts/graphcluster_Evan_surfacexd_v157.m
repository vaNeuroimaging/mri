function graphcluster_Evan_surfacexd_v157(prmfile,analysistype,xdistance,xdistancemat,makebinary,savematfile,clustertype,varargin)
%
% Name:graphcluster.m
% $Revision: 1.2 $
...
%         end
        ...
        % calculate the clusters for this network and store Q and partition
                ...
                [rawclrs(:,i,j) rawclrs_hier] = infomap_wrapper_v157(roifile,rmat,pajekfile,100,1);
%                 if issmallenough
...
if finaldim==1
    ...
    dlmwrite([outdir '/rawassn_hier.txt'],rawclrs_hier,'\t');
